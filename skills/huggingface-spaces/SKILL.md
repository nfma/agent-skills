...
metadata:
  ...
  skill-audit-context-requires: explicit_space_goal, target_space
...
compatibility: Requires the `hf` CLI, Hub network access, and authentication for Space changes; compute-backed Spaces also depend on account eligibility, quota, and billing.
---
