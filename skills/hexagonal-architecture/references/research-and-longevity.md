...
route: create
reason: Nuno requires ports-and-adapters as the default design lens for maintained software, backed by a deterministic validator suited to each repository. Language- and tool-specific integrations belong in separate bridge skills.
...
`architecture-criteria.md`. This skill owns the portable contract; separate
bridge skills own language- and tool-specific integrations.
...
```json
{
  ...
  "rationale": [
    ...
    "The portable core defines a language-neutral static validation contract. Volatile language and tool integrations are isolated in separate bridge skills."
  ],
  "death_modes": [
